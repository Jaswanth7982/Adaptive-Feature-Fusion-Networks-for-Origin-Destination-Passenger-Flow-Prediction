...
urlpatterns = [
    ...
    path('Predict_Passenger_Flow_Type/', remoteuser.Predict_Passenger_Flow_Type, name="Predict_Passenger_Flow_Type"),
    ...
    path('View_Predicted_Passenger_Flow_Type_Ratio/', serviceprovider.View_Predicted_Passenger_Flow_Type_Ratio, name="View_Predicted_Passenger_Flow_Type_Ratio"),
    path('train_model/', serviceprovider.train_model, name="train_model"),
    path('View_Predicted_Passenger_Flow_Type/', serviceprovider.View_Predicted_Passenger_Flow_Type, name="View_Predicted_Passenger_Flow_Type"),
